...
LevelDrawer* DrawMap(LevelParser* level, bool isOverworld, bool log, std::string destination) {
	...
	// 道具
	drawer->DrawItem({ 0, 1, 2, 3, 8, 10, 12, 13, 15, 18, 19, 20, 25, 28, 30, 31, 32, 33, 34, 35, 39, 78 }, false);
	drawer->DrawItem({ 40, 41, 42, 44, 45, 46, 47, 48, 52, 56, 57, 58, 60, 61, 62, 70, 74, 76, 77, 81, 92, 95, 98,
						 102, 103, 104 },
		false);
	drawer->DrawItem(
	...
	// 道具
	drawer->DrawItem({ 0, 1, 2, 3, 8, 10, 12, 13, 15, 18, 19, 20, 25, 28, 30, 31, 32, 33, 34, 35, 39, 78 }, true);
	drawer->DrawItem({ 40, 41, 42, 44, 45, 46, 47, 48, 52, 56, 57, 58, 60, 61, 62, 70, 74, 76, 77, 81, 92, 95, 98,
						 102, 103, 104 },
		true);
	drawer->DrawItem(
